...
---
### выдание 4.1.1 "Миростроенная Актуализация"
#### 5 мая 2023

- Зактуализовано секцию Другие
  - Зактуализовано Вселенная Ливулурия:
...
- Зактуализовано секцию Музыка
  - Исправлено проблему из «New Beginning» и «Espape of the Bits», которые не игралы
  - Поменьшие описательные исправления
- Зактуализовано секцию Что нового: Написано запис из 5 мая 2023
- Поменьшие описания в переводах
---
